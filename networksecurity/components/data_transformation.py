...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("get_data_transformer_data entered")
        try:
            imputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info("Initialize KNN Imputer With {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered in the initiate data tranformation method")
        try:
            ...
            data_transformation_artifact = DataTransformationArtifact(transformed_object_file_path = self.data_transformation_config.transformed_object_file_path,
                                                                   transformed_trained_file_path = self.data_transformation_config.transformed_train_file_path,
